...
export function Home() {
	...
	return (
		<div className={`${bg} ${text} min-h-screen flex items-center justify-center px-4 relative`}>
			...
			<div className='absolute bottom-4 left-4 flex gap-4 text-sm'>
				<TransitionLink to='/privacy' className='opacity-40 hover:opacity-70 underline'>
					{t('menu.privacy')}
				</TransitionLink>
				<TransitionLink to='/security' className='opacity-40 hover:opacity-70 underline'>
					{t('security.title')}
				</TransitionLink>
			</div>
		</div>
